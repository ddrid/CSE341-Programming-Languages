...
(* Problem 4 *)
fun longest_string_helper f strs = foldl (fn (x, y) => if f(x, y) then x else y) "" strs
val longest_string3 = longest_string_helper (fn (str1, str2) => String.size str1 > String.size str2)
val longest_string4 = longest_string_helper (fn (str1, str2) => String.size str1 >= String.size str2)
